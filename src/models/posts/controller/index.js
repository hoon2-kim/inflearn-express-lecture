...
import { pagination } from "../../../middleware/index";
...
class PostController {
    ...
    init() {
        ...
        this.router.post("/:id/like", this.postLike.bind(this));
    ...
    async getPosts(req, res, next) {
        try {
            // 정렬이나 조건문에 넣는 필터같은 경우는 query에 들어감
    ...
    async postLike(req, res, next) {
        try {
            ...
            const { id } = req.params;
            const { isLike } = req.body; // http 메소드가 post이므로 body로 받을 수 있음
